...
st.sidebar.image(r"/Users/anak/Downloads/uber2.png")
...
with st.container():
    ...
    with col2:
        st.image(r"/Users/anak/Downloads/uber3.jpeg", use_column_width=True)
...
with st.container():
    ...
    st.image(r"/Users/anak/Downloads/mapuber.png", use_column_width=True) 
...
with st.container():
    ...
    with col1:
        st.image(r"/Users/anak/Downloads/uber4.jpeg", use_column_width=True) 
...
if kmeans:
    with st.container():
        ...
        st.image(r"/Users/anak/Downloads/kmeans_elbow.png", use_column_width=True)
     
    with st.container():
        st.markdown(" ")
        st.markdown("### KMEANS Scatter")  
        st.image(r"/Users/anak/Downloads/KMeans6_scatter.png", use_column_width=True)
        
        
    with st.container():
        st.markdown(" ")
        st.markdown("### KMEANS Map")  
        st.image(r"/Users/anak/Downloads/kmeans_map.png", use_column_width=True)
...
if hiera:
    with st.container():
        ...
        st.image(r"/Users/anak/Downloads/HC_Dendrogram.png", use_column_width=True)
...
with st.container():
    ...
    if day:
        with st.container():
            ...
            with col3:
                st.image(r"/Users/anak/Downloads/uber8.png", use_column_width=True)
    ...
    if hour:
        with st.container():
            ...
            with col3:
                st.image(r"/Users/anak/Downloads/uber7.png", use_column_width=True)
    ...
    if both:
        ...
        with st.container():
            ...
            with col2:
                st.image(r"/Users/anak/Downloads/uber9.jpeg", use_column_width=True)
